;;;; examples/B1C11-16image.lisp

(in-package #:weekend-raytracer/examples)

(set-optimization-level)

(defun b1c11-16image (samples-per-pixel &optional verticalp)
...
One of the spheres is lambertian, one metal, one dialectric."
  ...
  (let* ((aspect-ratios '(1 16/9 64))
    ...
    (write-image #P"B1C11-16image" img
                 :border-width 2
