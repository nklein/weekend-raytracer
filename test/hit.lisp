...
(nst:def-test-group partial-hit-construction-tests ()
  (nst:def-test can-construct-a-partial-hit (:true)
    (let ((tt 3))
      (flet ((thunk ()
               (full-hit tt (vec 1 2 3) (vec 1 0 0))))
